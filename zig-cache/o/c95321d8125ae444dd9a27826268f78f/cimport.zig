...
pub const float16 = struct_float16; // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:590:3: warning: TODO implement translation of stmt class GCCAsmStmtClass
// C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:587:36: warning: unable to translate function, demoted to extern
...
pub const __mingw_flt_type_t = union___mingw_flt_type_t; // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:137:11: warning: struct demoted to opaque type - has bitfield
...
pub extern fn mInitWindow(width: c_int, height: c_int, title: [*c]const u8) void;
pub extern fn mCloseWindow() void;
pub extern fn mWindowShouldClose() bool;
pub extern fn mIsWindowReady() bool;
pub extern fn mIsWindowFullscreen() bool;
pub extern fn mIsWindowHidden() bool;
pub extern fn mIsWindowMinimized() bool;
pub extern fn mIsWindowMaximized() bool;
pub extern fn mIsWindowFocused() bool;
pub extern fn mIsWindowResized() bool;
pub extern fn mIsWindowState(flag: c_uint) bool;
pub extern fn mSetWindowState(flags: c_uint) void;
pub extern fn mClearWindowState(flags: c_uint) void;
pub extern fn mToggleFullscreen() void;
pub extern fn mToggleBorderlessWindowed() void;
pub extern fn mMaximizeWindow() void;
pub extern fn mMinimizeWindow() void;
pub extern fn mRestoreWindow() void;
pub extern fn mSetWindowIcon(image: [*c]Image) void;
pub extern fn mSetWindowIcons(images: [*c]Image, count: c_int) void;
pub extern fn mSetWindowTitle(title: [*c]const u8) void;
pub extern fn mSetWindowPosition(x: c_int, y: c_int) void;
pub extern fn mSetWindowMonitor(monitor: c_int) void;
pub extern fn mSetWindowMinSize(width: c_int, height: c_int) void;
pub extern fn mSetWindowMaxSize(width: c_int, height: c_int) void;
pub extern fn mSetWindowSize(width: c_int, height: c_int) void;
pub extern fn mSetWindowOpacity(opacity: f32) void;
pub extern fn mSetWindowFocused() void;
pub extern fn mGetScreenWidth() c_int;
pub extern fn mGetScreenHeight() c_int;
pub extern fn mGetRenderWidth() c_int;
pub extern fn mGetRenderHeight() c_int;
pub extern fn mGetMonitorCount() c_int;
pub extern fn mGetCurrentMonitor() c_int;
pub extern fn mGetMonitorPosition(out: [*c]Vector2, monitor: c_int) void;
pub extern fn mGetMonitorWidth(monitor: c_int) c_int;
pub extern fn mGetMonitorHeight(monitor: c_int) c_int;
pub extern fn mGetMonitorPhysicalWidth(monitor: c_int) c_int;
pub extern fn mGetMonitorPhysicalHeight(monitor: c_int) c_int;
pub extern fn mGetMonitorRefreshRate(monitor: c_int) c_int;
pub extern fn mGetWindowPosition(out: [*c]Vector2) void;
pub extern fn mGetWindowScaleDPI(out: [*c]Vector2) void;
pub extern fn mGetMonitorName(monitor: c_int) [*c]const u8;
pub extern fn mSetClipboardText(text: [*c]const u8) void;
pub extern fn mGetClipboardText() [*c]const u8;
pub extern fn mEnableEventWaiting() void;
pub extern fn mDisableEventWaiting() void;
pub extern fn mShowCursor() void;
pub extern fn mHideCursor() void;
pub extern fn mIsCursorHidden() bool;
pub extern fn mEnableCursor() void;
pub extern fn mDisableCursor() void;
pub extern fn mIsCursorOnScreen() bool;
pub extern fn mClearBackground(color: [*c]Color) void;
pub extern fn mBeginDrawing() void;
pub extern fn mEndDrawing() void;
pub extern fn mBeginMode2D(camera: [*c]Camera2D) void;
pub extern fn mEndMode2D() void;
pub extern fn mBeginMode3D(camera: [*c]Camera3D) void;
pub extern fn mEndMode3D() void;
pub extern fn mBeginTextureMode(target: [*c]RenderTexture2D) void;
pub extern fn mEndTextureMode() void;
pub extern fn mBeginShaderMode(shader: [*c]Shader) void;
pub extern fn mEndShaderMode() void;
pub extern fn mBeginBlendMode(mode: c_int) void;
pub extern fn mEndBlendMode() void;
pub extern fn mBeginScissorMode(x: c_int, y: c_int, width: c_int, height: c_int) void;
pub extern fn mEndScissorMode() void;
pub extern fn mBeginVrStereoMode(config: [*c]VrStereoConfig) void;
pub extern fn mEndVrStereoMode() void;
pub extern fn mLoadVrStereoConfig(out: [*c]VrStereoConfig, device: [*c]VrDeviceInfo) void;
pub extern fn mUnloadVrStereoConfig(config: [*c]VrStereoConfig) void;
pub extern fn mLoadShader(out: [*c]Shader, vsFileName: [*c]const u8, fsFileName: [*c]const u8) void;
pub extern fn mLoadShaderFromMemory(out: [*c]Shader, vsCode: [*c]const u8, fsCode: [*c]const u8) void;
pub extern fn mIsShaderReady(shader: [*c]Shader) bool;
pub extern fn mGetShaderLocation(shader: [*c]Shader, uniformName: [*c]const u8) c_int;
pub extern fn mGetShaderLocationAttrib(shader: [*c]Shader, attribName: [*c]const u8) c_int;
pub extern fn mSetShaderValue(shader: [*c]Shader, locIndex: c_int, value: ?*const anyopaque, uniformType: c_int) void;
pub extern fn mSetShaderValueV(shader: [*c]Shader, locIndex: c_int, value: ?*const anyopaque, uniformType: c_int, count: c_int) void;
pub extern fn mSetShaderValueMatrix(shader: [*c]Shader, locIndex: c_int, mat: [*c]Matrix) void;
pub extern fn mSetShaderValueTexture(shader: [*c]Shader, locIndex: c_int, texture: [*c]Texture2D) void;
pub extern fn mUnloadShader(shader: [*c]Shader) void;
pub extern fn mGetMouseRay(out: [*c]Ray, mousePosition: [*c]Vector2, camera: [*c]Camera3D) void;
pub extern fn mGetCameraMatrix(out: [*c]Matrix, camera: [*c]Camera3D) void;
pub extern fn mGetCameraMatrix2D(out: [*c]Matrix, camera: [*c]Camera2D) void;
pub extern fn mGetWorldToScreen(out: [*c]Vector2, position: [*c]Vector3, camera: [*c]Camera3D) void;
pub extern fn mGetScreenToWorld2D(out: [*c]Vector2, position: [*c]Vector2, camera: [*c]Camera2D) void;
pub extern fn mGetWorldToScreenEx(out: [*c]Vector2, position: [*c]Vector3, camera: [*c]Camera3D, width: c_int, height: c_int) void;
pub extern fn mGetWorldToScreen2D(out: [*c]Vector2, position: [*c]Vector2, camera: [*c]Camera2D) void;
pub extern fn mSetTargetFPS(fps: c_int) void;
pub extern fn mGetFrameTime() f32;
pub extern fn mGetTime() f64;
pub extern fn mGetFPS() c_int;
pub extern fn mSwapScreenBuffer() void;
pub extern fn mPollInputEvents() void;
pub extern fn mWaitTime(seconds: f64) void;
pub extern fn mSetRandomSeed(seed: c_uint) void;
pub extern fn mGetRandomValue(min: c_int, max: c_int) c_int;
pub extern fn mLoadRandomSequence(count: c_uint, min: c_int, max: c_int) [*c]c_int;
pub extern fn mUnloadRandomSequence(sequence: [*c]c_int) void;
pub extern fn mTakeScreenshot(fileName: [*c]const u8) void;
pub extern fn mOpenURL(url: [*c]const u8) void;
pub extern fn mSetTraceLogLevel(logLevel: c_int) void;
pub extern fn mSetLoadFileDataCallback(callback: LoadFileDataCallback) void;
pub extern fn mSetSaveFileDataCallback(callback: SaveFileDataCallback) void;
pub extern fn mSetLoadFileTextCallback(callback: LoadFileTextCallback) void;
pub extern fn mSetSaveFileTextCallback(callback: SaveFileTextCallback) void;
pub extern fn mSaveFileData(fileName: [*c]const u8, data: ?*anyopaque, dataSize: c_int) bool;
pub extern fn mExportDataAsCode(data: [*c]const u8, dataSize: c_int, fileName: [*c]const u8) bool;
pub extern fn mLoadFileText(fileName: [*c]const u8) [*c]u8;
pub extern fn mUnloadFileText(text: [*c]u8) void;
pub extern fn mSaveFileText(fileName: [*c]const u8, text: [*c]u8) bool;
pub extern fn mFileExists(fileName: [*c]const u8) bool;
pub extern fn mDirectoryExists(dirPath: [*c]const u8) bool;
pub extern fn mIsFileExtension(fileName: [*c]const u8, ext: [*c]const u8) bool;
pub extern fn mGetFileLength(fileName: [*c]const u8) c_int;
pub extern fn mGetFileExtension(fileName: [*c]const u8) [*c]const u8;
pub extern fn mGetFileName(filePath: [*c]const u8) [*c]const u8;
pub extern fn mGetFileNameWithoutExt(filePath: [*c]const u8) [*c]const u8;
pub extern fn mGetDirectoryPath(filePath: [*c]const u8) [*c]const u8;
pub extern fn mGetPrevDirectoryPath(dirPath: [*c]const u8) [*c]const u8;
pub extern fn mGetWorkingDirectory() [*c]const u8;
pub extern fn mGetApplicationDirectory() [*c]const u8;
pub extern fn mChangeDirectory(dir: [*c]const u8) bool;
pub extern fn mIsPathFile(path: [*c]const u8) bool;
pub extern fn mLoadDirectoryFiles(out: [*c]FilePathList, dirPath: [*c]const u8) void;
pub extern fn mLoadDirectoryFilesEx(out: [*c]FilePathList, basePath: [*c]const u8, filter: [*c]const u8, scanSubdirs: bool) void;
pub extern fn mUnloadDirectoryFiles(files: [*c]FilePathList) void;
pub extern fn mIsFileDropped() bool;
pub extern fn mLoadDroppedFiles(out: [*c]FilePathList) void;
pub extern fn mUnloadDroppedFiles(files: [*c]FilePathList) void;
pub extern fn mGetFileModTime(fileName: [*c]const u8) c_long;
pub extern fn mCompressData(data: [*c]const u8, dataSize: c_int, compDataSize: [*c]c_int) [*c]u8;
pub extern fn mDecompressData(compData: [*c]const u8, compDataSize: c_int, dataSize: [*c]c_int) [*c]u8;
pub extern fn mEncodeDataBase64(data: [*c]const u8, dataSize: c_int, outputSize: [*c]c_int) [*c]u8;
pub extern fn mDecodeDataBase64(data: [*c]const u8, outputSize: [*c]c_int) [*c]u8;
pub extern fn mLoadAutomationEventList(out: [*c]AutomationEventList, fileName: [*c]const u8) void;
pub extern fn mUnloadAutomationEventList(list: [*c]AutomationEventList) void;
pub extern fn mExportAutomationEventList(list: [*c]AutomationEventList, fileName: [*c]const u8) bool;
pub extern fn mSetAutomationEventList(list: [*c]AutomationEventList) void;
pub extern fn mSetAutomationEventBaseFrame(frame: c_int) void;
pub extern fn mStartAutomationEventRecording() void;
pub extern fn mStopAutomationEventRecording() void;
pub extern fn mPlayAutomationEvent(event: [*c]AutomationEvent) void;
pub extern fn mIsKeyPressed(key: c_int) bool;
pub extern fn mIsKeyPressedRepeat(key: c_int) bool;
pub extern fn mIsKeyDown(key: c_int) bool;
pub extern fn mIsKeyReleased(key: c_int) bool;
pub extern fn mIsKeyUp(key: c_int) bool;
pub extern fn mGetKeyPressed() c_int;
pub extern fn mGetCharPressed() c_int;
pub extern fn mSetExitKey(key: c_int) void;
pub extern fn mIsGamepadAvailable(gamepad: c_int) bool;
pub extern fn mGetGamepadName(gamepad: c_int) [*c]const u8;
pub extern fn mIsGamepadButtonPressed(gamepad: c_int, button: c_int) bool;
pub extern fn mIsGamepadButtonDown(gamepad: c_int, button: c_int) bool;
pub extern fn mIsGamepadButtonReleased(gamepad: c_int, button: c_int) bool;
pub extern fn mIsGamepadButtonUp(gamepad: c_int, button: c_int) bool;
pub extern fn mGetGamepadAxisCount(gamepad: c_int) c_int;
pub extern fn mGetGamepadAxisMovement(gamepad: c_int, axis: c_int) f32;
pub extern fn mSetGamepadMappings(mappings: [*c]const u8) c_int;
pub extern fn mIsMouseButtonPressed(button: c_int) bool;
pub extern fn mIsMouseButtonDown(button: c_int) bool;
pub extern fn mIsMouseButtonReleased(button: c_int) bool;
pub extern fn mIsMouseButtonUp(button: c_int) bool;
pub extern fn mGetMouseX() c_int;
pub extern fn mGetMouseY() c_int;
pub extern fn mGetMousePosition(out: [*c]Vector2) void;
pub extern fn mGetMouseDelta(out: [*c]Vector2) void;
pub extern fn mSetMousePosition(x: c_int, y: c_int) void;
pub extern fn mSetMouseOffset(offsetX: c_int, offsetY: c_int) void;
pub extern fn mSetMouseScale(scaleX: f32, scaleY: f32) void;
pub extern fn mGetMouseWheelMove() f32;
pub extern fn mGetMouseWheelMoveV(out: [*c]Vector2) void;
pub extern fn mSetMouseCursor(cursor: c_int) void;
pub extern fn mGetTouchX() c_int;
pub extern fn mGetTouchY() c_int;
pub extern fn mGetTouchPosition(out: [*c]Vector2, index: c_int) void;
pub extern fn mGetTouchPointId(index: c_int) c_int;
pub extern fn mGetTouchPointCount() c_int;
pub extern fn mSetGesturesEnabled(flags: c_uint) void;
pub extern fn mIsGestureDetected(gesture: c_uint) bool;
pub extern fn mGetGestureDetected() c_int;
pub extern fn mGetGestureHoldDuration() f32;
pub extern fn mGetGestureDragVector(out: [*c]Vector2) void;
pub extern fn mGetGestureDragAngle() f32;
pub extern fn mGetGesturePinchVector(out: [*c]Vector2) void;
pub extern fn mGetGesturePinchAngle() f32;
pub extern fn mUpdateCamera(camera: [*c]Camera, mode: c_int) void;
pub extern fn mUpdateCameraPro(camera: [*c]Camera, movement: [*c]Vector3, rotation: [*c]Vector3, zoom: f32) void;
pub extern fn mSetShapesTexture(texture: [*c]Texture2D, source: [*c]Rectangle) void;
pub extern fn mGetShapesTexture(out: [*c]Texture2D) void;
pub extern fn mGetShapesTextureRectangle(out: [*c]Rectangle) void;
pub extern fn mDrawPixel(posX: c_int, posY: c_int, color: [*c]Color) void;
pub extern fn mDrawPixelV(position: [*c]Vector2, color: [*c]Color) void;
pub extern fn mDrawLine(startPosX: c_int, startPosY: c_int, endPosX: c_int, endPosY: c_int, color: [*c]Color) void;
pub extern fn mDrawLineV(startPos: [*c]Vector2, endPos: [*c]Vector2, color: [*c]Color) void;
pub extern fn mDrawLineEx(startPos: [*c]Vector2, endPos: [*c]Vector2, thick: f32, color: [*c]Color) void;
pub extern fn mDrawLineStrip(points: [*c]Vector2, pointCount: c_int, color: [*c]Color) void;
pub extern fn mDrawLineBezier(startPos: [*c]Vector2, endPos: [*c]Vector2, thick: f32, color: [*c]Color) void;
pub extern fn mDrawCircle(centerX: c_int, centerY: c_int, radius: f32, color: [*c]Color) void;
pub extern fn mDrawCircleSector(center: [*c]Vector2, radius: f32, startAngle: f32, endAngle: f32, segments: c_int, color: [*c]Color) void;
pub extern fn mDrawCircleSectorLines(center: [*c]Vector2, radius: f32, startAngle: f32, endAngle: f32, segments: c_int, color: [*c]Color) void;
pub extern fn mDrawCircleGradient(centerX: c_int, centerY: c_int, radius: f32, color1: [*c]Color, color2: [*c]Color) void;
pub extern fn mDrawCircleV(center: [*c]Vector2, radius: f32, color: [*c]Color) void;
pub extern fn mDrawCircleLines(centerX: c_int, centerY: c_int, radius: f32, color: [*c]Color) void;
pub extern fn mDrawCircleLinesV(center: [*c]Vector2, radius: f32, color: [*c]Color) void;
pub extern fn mDrawEllipse(centerX: c_int, centerY: c_int, radiusH: f32, radiusV: f32, color: [*c]Color) void;
pub extern fn mDrawEllipseLines(centerX: c_int, centerY: c_int, radiusH: f32, radiusV: f32, color: [*c]Color) void;
pub extern fn mDrawRing(center: [*c]Vector2, innerRadius: f32, outerRadius: f32, startAngle: f32, endAngle: f32, segments: c_int, color: [*c]Color) void;
pub extern fn mDrawRingLines(center: [*c]Vector2, innerRadius: f32, outerRadius: f32, startAngle: f32, endAngle: f32, segments: c_int, color: [*c]Color) void;
pub extern fn mDrawRectangle(posX: c_int, posY: c_int, width: c_int, height: c_int, color: [*c]Color) void;
pub extern fn mDrawRectangleV(position: [*c]Vector2, size: [*c]Vector2, color: [*c]Color) void;
pub extern fn mDrawRectangleRec(rec: [*c]Rectangle, color: [*c]Color) void;
pub extern fn mDrawRectanglePro(rec: [*c]Rectangle, origin: [*c]Vector2, rotation: f32, color: [*c]Color) void;
pub extern fn mDrawRectangleGradientV(posX: c_int, posY: c_int, width: c_int, height: c_int, color1: [*c]Color, color2: [*c]Color) void;
pub extern fn mDrawRectangleGradientH(posX: c_int, posY: c_int, width: c_int, height: c_int, color1: [*c]Color, color2: [*c]Color) void;
pub extern fn mDrawRectangleGradientEx(rec: [*c]Rectangle, col1: [*c]Color, col2: [*c]Color, col3: [*c]Color, col4: [*c]Color) void;
pub extern fn mDrawRectangleLines(posX: c_int, posY: c_int, width: c_int, height: c_int, color: [*c]Color) void;
pub extern fn mDrawRectangleLinesEx(rec: [*c]Rectangle, lineThick: f32, color: [*c]Color) void;
pub extern fn mDrawRectangleRounded(rec: [*c]Rectangle, roundness: f32, segments: c_int, color: [*c]Color) void;
pub extern fn mDrawRectangleRoundedLines(rec: [*c]Rectangle, roundness: f32, segments: c_int, lineThick: f32, color: [*c]Color) void;
pub extern fn mDrawTriangle(v1: [*c]Vector2, v2: [*c]Vector2, v3: [*c]Vector2, color: [*c]Color) void;
pub extern fn mDrawTriangleLines(v1: [*c]Vector2, v2: [*c]Vector2, v3: [*c]Vector2, color: [*c]Color) void;
pub extern fn mDrawTriangleFan(points: [*c]Vector2, pointCount: c_int, color: [*c]Color) void;
pub extern fn mDrawTriangleStrip(points: [*c]Vector2, pointCount: c_int, color: [*c]Color) void;
pub extern fn mDrawPoly(center: [*c]Vector2, sides: c_int, radius: f32, rotation: f32, color: [*c]Color) void;
pub extern fn mDrawPolyLines(center: [*c]Vector2, sides: c_int, radius: f32, rotation: f32, color: [*c]Color) void;
pub extern fn mDrawPolyLinesEx(center: [*c]Vector2, sides: c_int, radius: f32, rotation: f32, lineThick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineLinear(points: [*c]Vector2, pointCount: c_int, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineBasis(points: [*c]Vector2, pointCount: c_int, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineCatmullRom(points: [*c]Vector2, pointCount: c_int, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineBezierQuadratic(points: [*c]Vector2, pointCount: c_int, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineBezierCubic(points: [*c]Vector2, pointCount: c_int, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineSegmentLinear(p1: [*c]Vector2, p2: [*c]Vector2, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineSegmentBasis(p1: [*c]Vector2, p2: [*c]Vector2, p3: [*c]Vector2, p4: [*c]Vector2, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineSegmentCatmullRom(p1: [*c]Vector2, p2: [*c]Vector2, p3: [*c]Vector2, p4: [*c]Vector2, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineSegmentBezierQuadratic(p1: [*c]Vector2, c2: [*c]Vector2, p3: [*c]Vector2, thick: f32, color: [*c]Color) void;
pub extern fn mDrawSplineSegmentBezierCubic(p1: [*c]Vector2, c2: [*c]Vector2, c3: [*c]Vector2, p4: [*c]Vector2, thick: f32, color: [*c]Color) void;
pub extern fn mGetSplinePointLinear(out: [*c]Vector2, startPos: [*c]Vector2, endPos: [*c]Vector2, t: f32) void;
pub extern fn mGetSplinePointBasis(out: [*c]Vector2, p1: [*c]Vector2, p2: [*c]Vector2, p3: [*c]Vector2, p4: [*c]Vector2, t: f32) void;
pub extern fn mGetSplinePointCatmullRom(out: [*c]Vector2, p1: [*c]Vector2, p2: [*c]Vector2, p3: [*c]Vector2, p4: [*c]Vector2, t: f32) void;
pub extern fn mGetSplinePointBezierQuad(out: [*c]Vector2, p1: [*c]Vector2, c2: [*c]Vector2, p3: [*c]Vector2, t: f32) void;
pub extern fn mGetSplinePointBezierCubic(out: [*c]Vector2, p1: [*c]Vector2, c2: [*c]Vector2, c3: [*c]Vector2, p4: [*c]Vector2, t: f32) void;
pub extern fn mCheckCollisionRecs(rec1: [*c]Rectangle, rec2: [*c]Rectangle) bool;
pub extern fn mCheckCollisionCircles(center1: [*c]Vector2, radius1: f32, center2: [*c]Vector2, radius2: f32) bool;
pub extern fn mCheckCollisionCircleRec(center: [*c]Vector2, radius: f32, rec: [*c]Rectangle) bool;
pub extern fn mCheckCollisionPointRec(point: [*c]Vector2, rec: [*c]Rectangle) bool;
pub extern fn mCheckCollisionPointCircle(point: [*c]Vector2, center: [*c]Vector2, radius: f32) bool;
pub extern fn mCheckCollisionPointTriangle(point: [*c]Vector2, p1: [*c]Vector2, p2: [*c]Vector2, p3: [*c]Vector2) bool;
pub extern fn mCheckCollisionPointPoly(point: [*c]Vector2, points: [*c]Vector2, pointCount: c_int) bool;
pub extern fn mCheckCollisionLines(startPos1: [*c]Vector2, endPos1: [*c]Vector2, startPos2: [*c]Vector2, endPos2: [*c]Vector2, collisionPoint: [*c]Vector2) bool;
pub extern fn mCheckCollisionPointLine(point: [*c]Vector2, p1: [*c]Vector2, p2: [*c]Vector2, threshold: c_int) bool;
pub extern fn mGetCollisionRec(out: [*c]Rectangle, rec1: [*c]Rectangle, rec2: [*c]Rectangle) void;
pub extern fn mLoadImage(out: [*c]Image, fileName: [*c]const u8) void;
pub extern fn mLoadImageRaw(out: [*c]Image, fileName: [*c]const u8, width: c_int, height: c_int, format: c_int, headerSize: c_int) void;
pub extern fn mLoadImageSvg(out: [*c]Image, fileNameOrString: [*c]const u8, width: c_int, height: c_int) void;
pub extern fn mLoadImageAnim(out: [*c]Image, fileName: [*c]const u8, frames: [*c]c_int) void;
pub extern fn mLoadImageAnimFromMemory(out: [*c]Image, fileType: [*c]const u8, fileData: [*c]const u8, dataSize: c_int, frames: [*c]c_int) void;
pub extern fn mLoadImageFromMemory(out: [*c]Image, fileType: [*c]const u8, fileData: [*c]const u8, dataSize: c_int) void;
pub extern fn mLoadImageFromTexture(out: [*c]Image, texture: [*c]Texture2D) void;
pub extern fn mLoadImageFromScreen(out: [*c]Image) void;
pub extern fn mIsImageReady(image: [*c]Image) bool;
pub extern fn mUnloadImage(image: [*c]Image) void;
pub extern fn mExportImage(image: [*c]Image, fileName: [*c]const u8) bool;
pub extern fn mExportImageToMemory(image: [*c]Image, fileType: [*c]const u8, fileSize: [*c]c_int) [*c]u8;
pub extern fn mExportImageAsCode(image: [*c]Image, fileName: [*c]const u8) bool;
pub extern fn mGenImageColor(out: [*c]Image, width: c_int, height: c_int, color: [*c]Color) void;
pub extern fn mGenImageGradientLinear(out: [*c]Image, width: c_int, height: c_int, direction: c_int, start: [*c]Color, end: [*c]Color) void;
pub extern fn mGenImageGradientRadial(out: [*c]Image, width: c_int, height: c_int, density: f32, inner: [*c]Color, outer: [*c]Color) void;
pub extern fn mGenImageGradientSquare(out: [*c]Image, width: c_int, height: c_int, density: f32, inner: [*c]Color, outer: [*c]Color) void;
pub extern fn mGenImageChecked(out: [*c]Image, width: c_int, height: c_int, checksX: c_int, checksY: c_int, col1: [*c]Color, col2: [*c]Color) void;
pub extern fn mGenImageWhiteNoise(out: [*c]Image, width: c_int, height: c_int, factor: f32) void;
pub extern fn mGenImagePerlinNoise(out: [*c]Image, width: c_int, height: c_int, offsetX: c_int, offsetY: c_int, scale: f32) void;
pub extern fn mGenImageCellular(out: [*c]Image, width: c_int, height: c_int, tileSize: c_int) void;
pub extern fn mGenImageText(out: [*c]Image, width: c_int, height: c_int, text: [*c]const u8) void;
pub extern fn mImageCopy(out: [*c]Image, image: [*c]Image) void;
pub extern fn mImageFromImage(out: [*c]Image, image: [*c]Image, rec: [*c]Rectangle) void;
pub extern fn mImageText(out: [*c]Image, text: [*c]const u8, fontSize: c_int, color: [*c]Color) void;
pub extern fn mImageTextEx(out: [*c]Image, font: [*c]Font, text: [*c]const u8, fontSize: f32, spacing: f32, tint: [*c]Color) void;
pub extern fn mImageFormat(image: [*c]Image, newFormat: c_int) void;
pub extern fn mImageToPOT(image: [*c]Image, fill: [*c]Color) void;
pub extern fn mImageCrop(image: [*c]Image, crop: [*c]Rectangle) void;
pub extern fn mImageAlphaCrop(image: [*c]Image, threshold: f32) void;
pub extern fn mImageAlphaClear(image: [*c]Image, color: [*c]Color, threshold: f32) void;
pub extern fn mImageAlphaMask(image: [*c]Image, alphaMask: [*c]Image) void;
pub extern fn mImageAlphaPremultiply(image: [*c]Image) void;
pub extern fn mImageBlurGaussian(image: [*c]Image, blurSize: c_int) void;
pub extern fn mImageKernelConvolution(image: [*c]Image, kernel: [*c]f32, kernelSize: c_int) void;
pub extern fn mImageResize(image: [*c]Image, newWidth: c_int, newHeight: c_int) void;
pub extern fn mImageResizeNN(image: [*c]Image, newWidth: c_int, newHeight: c_int) void;
pub extern fn mImageResizeCanvas(image: [*c]Image, newWidth: c_int, newHeight: c_int, offsetX: c_int, offsetY: c_int, fill: [*c]Color) void;
pub extern fn mImageMipmaps(image: [*c]Image) void;
pub extern fn mImageDither(image: [*c]Image, rBpp: c_int, gBpp: c_int, bBpp: c_int, aBpp: c_int) void;
pub extern fn mImageFlipVertical(image: [*c]Image) void;
pub extern fn mImageFlipHorizontal(image: [*c]Image) void;
pub extern fn mImageRotate(image: [*c]Image, degrees: c_int) void;
pub extern fn mImageRotateCW(image: [*c]Image) void;
pub extern fn mImageRotateCCW(image: [*c]Image) void;
pub extern fn mImageColorTint(image: [*c]Image, color: [*c]Color) void;
pub extern fn mImageColorInvert(image: [*c]Image) void;
pub extern fn mImageColorGrayscale(image: [*c]Image) void;
pub extern fn mImageColorContrast(image: [*c]Image, contrast: f32) void;
pub extern fn mImageColorBrightness(image: [*c]Image, brightness: c_int) void;
pub extern fn mImageColorReplace(image: [*c]Image, color: [*c]Color, replace: [*c]Color) void;
pub extern fn mLoadImageColors(image: [*c]Image) [*c]Color;
pub extern fn mLoadImagePalette(image: [*c]Image, maxPaletteSize: c_int, colorCount: [*c]c_int) [*c]Color;
pub extern fn mUnloadImageColors(colors: [*c]Color) void;
pub extern fn mUnloadImagePalette(colors: [*c]Color) void;
pub extern fn mGetImageAlphaBorder(out: [*c]Rectangle, image: [*c]Image, threshold: f32) void;
pub extern fn mGetImageColor(out: [*c]Color, image: [*c]Image, x: c_int, y: c_int) void;
pub extern fn mImageClearBackground(dst: [*c]Image, color: [*c]Color) void;
pub extern fn mImageDrawPixel(dst: [*c]Image, posX: c_int, posY: c_int, color: [*c]Color) void;
pub extern fn mImageDrawPixelV(dst: [*c]Image, position: [*c]Vector2, color: [*c]Color) void;
pub extern fn mImageDrawLine(dst: [*c]Image, startPosX: c_int, startPosY: c_int, endPosX: c_int, endPosY: c_int, color: [*c]Color) void;
pub extern fn mImageDrawLineV(dst: [*c]Image, start: [*c]Vector2, end: [*c]Vector2, color: [*c]Color) void;
pub extern fn mImageDrawCircle(dst: [*c]Image, centerX: c_int, centerY: c_int, radius: c_int, color: [*c]Color) void;
pub extern fn mImageDrawCircleV(dst: [*c]Image, center: [*c]Vector2, radius: c_int, color: [*c]Color) void;
pub extern fn mImageDrawCircleLines(dst: [*c]Image, centerX: c_int, centerY: c_int, radius: c_int, color: [*c]Color) void;
pub extern fn mImageDrawCircleLinesV(dst: [*c]Image, center: [*c]Vector2, radius: c_int, color: [*c]Color) void;
pub extern fn mImageDrawRectangle(dst: [*c]Image, posX: c_int, posY: c_int, width: c_int, height: c_int, color: [*c]Color) void;
pub extern fn mImageDrawRectangleV(dst: [*c]Image, position: [*c]Vector2, size: [*c]Vector2, color: [*c]Color) void;
pub extern fn mImageDrawRectangleRec(dst: [*c]Image, rec: [*c]Rectangle, color: [*c]Color) void;
pub extern fn mImageDrawRectangleLines(dst: [*c]Image, rec: [*c]Rectangle, thick: c_int, color: [*c]Color) void;
pub extern fn mImageDraw(dst: [*c]Image, src: [*c]Image, srcRec: [*c]Rectangle, dstRec: [*c]Rectangle, tint: [*c]Color) void;
pub extern fn mImageDrawText(dst: [*c]Image, text: [*c]const u8, posX: c_int, posY: c_int, fontSize: c_int, color: [*c]Color) void;
pub extern fn mImageDrawTextEx(dst: [*c]Image, font: [*c]Font, text: [*c]const u8, position: [*c]Vector2, fontSize: f32, spacing: f32, tint: [*c]Color) void;
pub extern fn mLoadTexture(out: [*c]Texture2D, fileName: [*c]const u8) void;
pub extern fn mLoadTextureFromImage(out: [*c]Texture2D, image: [*c]Image) void;
pub extern fn mLoadTextureCubemap(out: [*c]Texture2D, image: [*c]Image, layout: c_int) void;
pub extern fn mLoadRenderTexture(out: [*c]RenderTexture2D, width: c_int, height: c_int) void;
pub extern fn mIsTextureReady(texture: [*c]Texture2D) bool;
pub extern fn mUnloadTexture(texture: [*c]Texture2D) void;
pub extern fn mIsRenderTextureReady(target: [*c]RenderTexture2D) bool;
pub extern fn mUnloadRenderTexture(target: [*c]RenderTexture2D) void;
pub extern fn mUpdateTexture(texture: [*c]Texture2D, pixels: ?*const anyopaque) void;
pub extern fn mUpdateTextureRec(texture: [*c]Texture2D, rec: [*c]Rectangle, pixels: ?*const anyopaque) void;
pub extern fn mGenTextureMipmaps(texture: [*c]Texture2D) void;
pub extern fn mSetTextureFilter(texture: [*c]Texture2D, filter: c_int) void;
pub extern fn mSetTextureWrap(texture: [*c]Texture2D, wrap: c_int) void;
pub extern fn mDrawTexture(texture: [*c]Texture2D, posX: c_int, posY: c_int, tint: [*c]Color) void;
pub extern fn mDrawTextureV(texture: [*c]Texture2D, position: [*c]Vector2, tint: [*c]Color) void;
pub extern fn mDrawTextureEx(texture: [*c]Texture2D, position: [*c]Vector2, rotation: f32, scale: f32, tint: [*c]Color) void;
pub extern fn mDrawTextureRec(texture: [*c]Texture2D, source: [*c]Rectangle, position: [*c]Vector2, tint: [*c]Color) void;
pub extern fn mDrawTexturePro(texture: [*c]Texture2D, source: [*c]Rectangle, dest: [*c]Rectangle, origin: [*c]Vector2, rotation: f32, tint: [*c]Color) void;
pub extern fn mDrawTextureNPatch(texture: [*c]Texture2D, nPatchInfo: [*c]NPatchInfo, dest: [*c]Rectangle, origin: [*c]Vector2, rotation: f32, tint: [*c]Color) void;
pub extern fn mFade(out: [*c]Color, color: [*c]Color, alpha: f32) void;
pub extern fn mColorToInt(color: [*c]Color) c_int;
pub extern fn mColorNormalize(out: [*c]Vector4, color: [*c]Color) void;
pub extern fn mColorFromNormalized(out: [*c]Color, normalized: [*c]Vector4) void;
pub extern fn mColorToHSV(out: [*c]Vector3, color: [*c]Color) void;
pub extern fn mColorFromHSV(out: [*c]Color, hue: f32, saturation: f32, value: f32) void;
pub extern fn mColorTint(out: [*c]Color, color: [*c]Color, tint: [*c]Color) void;
pub extern fn mColorBrightness(out: [*c]Color, color: [*c]Color, factor: f32) void;
pub extern fn mColorContrast(out: [*c]Color, color: [*c]Color, contrast: f32) void;
pub extern fn mColorAlpha(out: [*c]Color, color: [*c]Color, alpha: f32) void;
pub extern fn mColorAlphaBlend(out: [*c]Color, dst: [*c]Color, src: [*c]Color, tint: [*c]Color) void;
pub extern fn mGetColor(out: [*c]Color, hexValue: c_uint) void;
pub extern fn mGetPixelColor(out: [*c]Color, srcPtr: ?*anyopaque, format: c_int) void;
pub extern fn mSetPixelColor(dstPtr: ?*anyopaque, color: [*c]Color, format: c_int) void;
pub extern fn mGetPixelDataSize(width: c_int, height: c_int, format: c_int) c_int;
pub extern fn mGetFontDefault(out: [*c]Font) void;
pub extern fn mLoadFont(out: [*c]Font, fileName: [*c]const u8) void;
pub extern fn mLoadFontEx(out: [*c]Font, fileName: [*c]const u8, fontSize: c_int, codepoints: [*c]c_int, codepointCount: c_int) void;
pub extern fn mLoadFontFromImage(out: [*c]Font, image: [*c]Image, key: [*c]Color, firstChar: c_int) void;
pub extern fn mLoadFontFromMemory(out: [*c]Font, fileType: [*c]const u8, fileData: [*c]const u8, dataSize: c_int, fontSize: c_int, codepoints: [*c]c_int, codepointCount: c_int) void;
pub extern fn mIsFontReady(font: [*c]Font) bool;
pub extern fn mLoadFontData(fileData: [*c]const u8, dataSize: c_int, fontSize: c_int, codepoints: [*c]c_int, codepointCount: c_int, @"type": c_int) [*c]GlyphInfo;
pub extern fn mUnloadFontData(glyphs: [*c]GlyphInfo, glyphCount: c_int) void;
pub extern fn mUnloadFont(font: [*c]Font) void;
pub extern fn mExportFontAsCode(font: [*c]Font, fileName: [*c]const u8) bool;
pub extern fn mDrawFPS(posX: c_int, posY: c_int) void;
pub extern fn mDrawText(text: [*c]const u8, posX: c_int, posY: c_int, fontSize: c_int, color: [*c]Color) void;
pub extern fn mDrawTextEx(font: [*c]Font, text: [*c]const u8, position: [*c]Vector2, fontSize: f32, spacing: f32, tint: [*c]Color) void;
pub extern fn mDrawTextPro(font: [*c]Font, text: [*c]const u8, position: [*c]Vector2, origin: [*c]Vector2, rotation: f32, fontSize: f32, spacing: f32, tint: [*c]Color) void;
pub extern fn mDrawTextCodepoint(font: [*c]Font, codepoint: c_int, position: [*c]Vector2, fontSize: f32, tint: [*c]Color) void;
pub extern fn mDrawTextCodepoints(font: [*c]Font, codepoints: [*c]const c_int, codepointCount: c_int, position: [*c]Vector2, fontSize: f32, spacing: f32, tint: [*c]Color) void;
pub extern fn mSetTextLineSpacing(spacing: c_int) void;
pub extern fn mMeasureText(text: [*c]const u8, fontSize: c_int) c_int;
pub extern fn mMeasureTextEx(out: [*c]Vector2, font: [*c]Font, text: [*c]const u8, fontSize: f32, spacing: f32) void;
pub extern fn mGetGlyphIndex(font: [*c]Font, codepoint: c_int) c_int;
pub extern fn mGetGlyphInfo(out: [*c]GlyphInfo, font: [*c]Font, codepoint: c_int) void;
pub extern fn mGetGlyphAtlasRec(out: [*c]Rectangle, font: [*c]Font, codepoint: c_int) void;
pub extern fn mLoadUTF8(codepoints: [*c]const c_int, length: c_int) [*c]u8;
pub extern fn mUnloadUTF8(text: [*c]u8) void;
pub extern fn mLoadCodepoints(text: [*c]const u8, count: [*c]c_int) [*c]c_int;
pub extern fn mUnloadCodepoints(codepoints: [*c]c_int) void;
pub extern fn mGetCodepointCount(text: [*c]const u8) c_int;
pub extern fn mGetCodepoint(text: [*c]const u8, codepointSize: [*c]c_int) c_int;
pub extern fn mGetCodepointNext(text: [*c]const u8, codepointSize: [*c]c_int) c_int;
pub extern fn mGetCodepointPrevious(text: [*c]const u8, codepointSize: [*c]c_int) c_int;
pub extern fn mCodepointToUTF8(codepoint: c_int, utf8Size: [*c]c_int) [*c]const u8;
pub extern fn mTextCopy(dst: [*c]u8, src: [*c]const u8) c_int;
pub extern fn mTextIsEqual(text1: [*c]const u8, text2: [*c]const u8) bool;
pub extern fn mTextLength(text: [*c]const u8) c_uint;
pub extern fn mTextSubtext(text: [*c]const u8, position: c_int, length: c_int) [*c]const u8;
pub extern fn mTextReplace(text: [*c]const u8, replace: [*c]const u8, by: [*c]const u8) [*c]u8;
pub extern fn mTextInsert(text: [*c]const u8, insert: [*c]const u8, position: c_int) [*c]u8;
pub extern fn mTextFindIndex(text: [*c]const u8, find: [*c]const u8) c_int;
pub extern fn mTextToUpper(text: [*c]const u8) [*c]const u8;
pub extern fn mTextToLower(text: [*c]const u8) [*c]const u8;
pub extern fn mTextToPascal(text: [*c]const u8) [*c]const u8;
pub extern fn mTextToInteger(text: [*c]const u8) c_int;
pub extern fn mTextToFloat(text: [*c]const u8) f32;
pub extern fn mDrawLine3D(startPos: [*c]Vector3, endPos: [*c]Vector3, color: [*c]Color) void;
pub extern fn mDrawPoint3D(position: [*c]Vector3, color: [*c]Color) void;
pub extern fn mDrawCircle3D(center: [*c]Vector3, radius: f32, rotationAxis: [*c]Vector3, rotationAngle: f32, color: [*c]Color) void;
pub extern fn mDrawTriangle3D(v1: [*c]Vector3, v2: [*c]Vector3, v3: [*c]Vector3, color: [*c]Color) void;
pub extern fn mDrawTriangleStrip3D(points: [*c]Vector3, pointCount: c_int, color: [*c]Color) void;
pub extern fn mDrawCube(position: [*c]Vector3, width: f32, height: f32, length: f32, color: [*c]Color) void;
pub extern fn mDrawCubeV(position: [*c]Vector3, size: [*c]Vector3, color: [*c]Color) void;
pub extern fn mDrawCubeWires(position: [*c]Vector3, width: f32, height: f32, length: f32, color: [*c]Color) void;
pub extern fn mDrawCubeWiresV(position: [*c]Vector3, size: [*c]Vector3, color: [*c]Color) void;
pub extern fn mDrawSphere(centerPos: [*c]Vector3, radius: f32, color: [*c]Color) void;
pub extern fn mDrawSphereEx(centerPos: [*c]Vector3, radius: f32, rings: c_int, slices: c_int, color: [*c]Color) void;
pub extern fn mDrawSphereWires(centerPos: [*c]Vector3, radius: f32, rings: c_int, slices: c_int, color: [*c]Color) void;
pub extern fn mDrawCylinder(position: [*c]Vector3, radiusTop: f32, radiusBottom: f32, height: f32, slices: c_int, color: [*c]Color) void;
pub extern fn mDrawCylinderEx(startPos: [*c]Vector3, endPos: [*c]Vector3, startRadius: f32, endRadius: f32, sides: c_int, color: [*c]Color) void;
pub extern fn mDrawCylinderWires(position: [*c]Vector3, radiusTop: f32, radiusBottom: f32, height: f32, slices: c_int, color: [*c]Color) void;
pub extern fn mDrawCylinderWiresEx(startPos: [*c]Vector3, endPos: [*c]Vector3, startRadius: f32, endRadius: f32, sides: c_int, color: [*c]Color) void;
pub extern fn mDrawCapsule(startPos: [*c]Vector3, endPos: [*c]Vector3, radius: f32, slices: c_int, rings: c_int, color: [*c]Color) void;
pub extern fn mDrawCapsuleWires(startPos: [*c]Vector3, endPos: [*c]Vector3, radius: f32, slices: c_int, rings: c_int, color: [*c]Color) void;
pub extern fn mDrawPlane(centerPos: [*c]Vector3, size: [*c]Vector2, color: [*c]Color) void;
pub extern fn mDrawRay(ray: [*c]Ray, color: [*c]Color) void;
pub extern fn mDrawGrid(slices: c_int, spacing: f32) void;
pub extern fn mLoadModel(out: [*c]Model, fileName: [*c]const u8) void;
pub extern fn mLoadModelFromMesh(out: [*c]Model, mesh: [*c]Mesh) void;
pub extern fn mIsModelReady(model: [*c]Model) bool;
pub extern fn mUnloadModel(model: [*c]Model) void;
pub extern fn mGetModelBoundingBox(out: [*c]BoundingBox, model: [*c]Model) void;
pub extern fn mDrawModel(model: [*c]Model, position: [*c]Vector3, scale: f32, tint: [*c]Color) void;
pub extern fn mDrawModelEx(model: [*c]Model, position: [*c]Vector3, rotationAxis: [*c]Vector3, rotationAngle: f32, scale: [*c]Vector3, tint: [*c]Color) void;
pub extern fn mDrawModelWires(model: [*c]Model, position: [*c]Vector3, scale: f32, tint: [*c]Color) void;
pub extern fn mDrawModelWiresEx(model: [*c]Model, position: [*c]Vector3, rotationAxis: [*c]Vector3, rotationAngle: f32, scale: [*c]Vector3, tint: [*c]Color) void;
pub extern fn mDrawBoundingBox(box: [*c]BoundingBox, color: [*c]Color) void;
pub extern fn mDrawBillboard(camera: [*c]Camera3D, texture: [*c]Texture2D, position: [*c]Vector3, size: f32, tint: [*c]Color) void;
pub extern fn mDrawBillboardRec(camera: [*c]Camera3D, texture: [*c]Texture2D, source: [*c]Rectangle, position: [*c]Vector3, size: [*c]Vector2, tint: [*c]Color) void;
pub extern fn mDrawBillboardPro(camera: [*c]Camera3D, texture: [*c]Texture2D, source: [*c]Rectangle, position: [*c]Vector3, up: [*c]Vector3, size: [*c]Vector2, origin: [*c]Vector2, rotation: f32, tint: [*c]Color) void;
pub extern fn mUploadMesh(mesh: [*c]Mesh, dynamic: bool) void;
pub extern fn mUpdateMeshBuffer(mesh: [*c]Mesh, index: c_int, data: ?*const anyopaque, dataSize: c_int, offset: c_int) void;
pub extern fn mUnloadMesh(mesh: [*c]Mesh) void;
pub extern fn mDrawMesh(mesh: [*c]Mesh, material: [*c]Material, transform: [*c]Matrix) void;
pub extern fn mDrawMeshInstanced(mesh: [*c]Mesh, material: [*c]Material, transforms: [*c]const Matrix, instances: c_int) void;
pub extern fn mGetMeshBoundingBox(out: [*c]BoundingBox, mesh: [*c]Mesh) void;
pub extern fn mGenMeshTangents(mesh: [*c]Mesh) void;
pub extern fn mExportMesh(mesh: [*c]Mesh, fileName: [*c]const u8) bool;
pub extern fn mExportMeshAsCode(mesh: [*c]Mesh, fileName: [*c]const u8) bool;
pub extern fn mGenMeshPoly(out: [*c]Mesh, sides: c_int, radius: f32) void;
pub extern fn mGenMeshPlane(out: [*c]Mesh, width: f32, length: f32, resX: c_int, resZ: c_int) void;
pub extern fn mGenMeshCube(out: [*c]Mesh, width: f32, height: f32, length: f32) void;
pub extern fn mGenMeshSphere(out: [*c]Mesh, radius: f32, rings: c_int, slices: c_int) void;
pub extern fn mGenMeshHemiSphere(out: [*c]Mesh, radius: f32, rings: c_int, slices: c_int) void;
pub extern fn mGenMeshCylinder(out: [*c]Mesh, radius: f32, height: f32, slices: c_int) void;
pub extern fn mGenMeshCone(out: [*c]Mesh, radius: f32, height: f32, slices: c_int) void;
pub extern fn mGenMeshTorus(out: [*c]Mesh, radius: f32, size: f32, radSeg: c_int, sides: c_int) void;
pub extern fn mGenMeshKnot(out: [*c]Mesh, radius: f32, size: f32, radSeg: c_int, sides: c_int) void;
pub extern fn mGenMeshHeightmap(out: [*c]Mesh, heightmap: [*c]Image, size: [*c]Vector3) void;
pub extern fn mGenMeshCubicmap(out: [*c]Mesh, cubicmap: [*c]Image, cubeSize: [*c]Vector3) void;
pub extern fn mLoadMaterials(fileName: [*c]const u8, materialCount: [*c]c_int) [*c]Material;
pub extern fn mLoadMaterialDefault(out: [*c]Material) void;
pub extern fn mIsMaterialReady(material: [*c]Material) bool;
pub extern fn mUnloadMaterial(material: [*c]Material) void;
pub extern fn mSetMaterialTexture(material: [*c]Material, mapType: c_int, texture: [*c]Texture2D) void;
pub extern fn mSetModelMeshMaterial(model: [*c]Model, meshId: c_int, materialId: c_int) void;
pub extern fn mLoadModelAnimations(fileName: [*c]const u8, animCount: [*c]c_int) [*c]ModelAnimation;
pub extern fn mUpdateModelAnimation(model: [*c]Model, anim: [*c]ModelAnimation, frame: c_int) void;
pub extern fn mUnloadModelAnimation(anim: [*c]ModelAnimation) void;
pub extern fn mUnloadModelAnimations(animations: [*c]ModelAnimation, animCount: c_int) void;
pub extern fn mIsModelAnimationValid(model: [*c]Model, anim: [*c]ModelAnimation) bool;
pub extern fn mCheckCollisionSpheres(center1: [*c]Vector3, radius1: f32, center2: [*c]Vector3, radius2: f32) bool;
pub extern fn mCheckCollisionBoxes(box1: [*c]BoundingBox, box2: [*c]BoundingBox) bool;
pub extern fn mCheckCollisionBoxSphere(box: [*c]BoundingBox, center: [*c]Vector3, radius: f32) bool;
pub extern fn mGetRayCollisionSphere(out: [*c]RayCollision, ray: [*c]Ray, center: [*c]Vector3, radius: f32) void;
pub extern fn mGetRayCollisionBox(out: [*c]RayCollision, ray: [*c]Ray, box: [*c]BoundingBox) void;
pub extern fn mGetRayCollisionMesh(out: [*c]RayCollision, ray: [*c]Ray, mesh: [*c]Mesh, transform: [*c]Matrix) void;
pub extern fn mGetRayCollisionTriangle(out: [*c]RayCollision, ray: [*c]Ray, p1: [*c]Vector3, p2: [*c]Vector3, p3: [*c]Vector3) void;
pub extern fn mGetRayCollisionQuad(out: [*c]RayCollision, ray: [*c]Ray, p1: [*c]Vector3, p2: [*c]Vector3, p3: [*c]Vector3, p4: [*c]Vector3) void;
pub extern fn mInitAudioDevice() void;
pub extern fn mCloseAudioDevice() void;
pub extern fn mIsAudioDeviceReady() bool;
pub extern fn mSetMasterVolume(volume: f32) void;
pub extern fn mGetMasterVolume() f32;
pub extern fn mLoadWave(out: [*c]Wave, fileName: [*c]const u8) void;
pub extern fn mLoadWaveFromMemory(out: [*c]Wave, fileType: [*c]const u8, fileData: [*c]const u8, dataSize: c_int) void;
pub extern fn mIsWaveReady(wave: [*c]Wave) bool;
pub extern fn mLoadSound(out: [*c]Sound, fileName: [*c]const u8) void;
pub extern fn mLoadSoundFromWave(out: [*c]Sound, wave: [*c]Wave) void;
pub extern fn mLoadSoundAlias(out: [*c]Sound, source: [*c]Sound) void;
pub extern fn mIsSoundReady(sound: [*c]Sound) bool;
pub extern fn mUpdateSound(sound: [*c]Sound, data: ?*const anyopaque, sampleCount: c_int) void;
pub extern fn mUnloadWave(wave: [*c]Wave) void;
pub extern fn mUnloadSound(sound: [*c]Sound) void;
pub extern fn mUnloadSoundAlias(alias: [*c]Sound) void;
pub extern fn mExportWave(wave: [*c]Wave, fileName: [*c]const u8) bool;
pub extern fn mExportWaveAsCode(wave: [*c]Wave, fileName: [*c]const u8) bool;
pub extern fn mPlaySound(sound: [*c]Sound) void;
pub extern fn mStopSound(sound: [*c]Sound) void;
pub extern fn mPauseSound(sound: [*c]Sound) void;
pub extern fn mResumeSound(sound: [*c]Sound) void;
pub extern fn mIsSoundPlaying(sound: [*c]Sound) bool;
pub extern fn mSetSoundVolume(sound: [*c]Sound, volume: f32) void;
pub extern fn mSetSoundPitch(sound: [*c]Sound, pitch: f32) void;
pub extern fn mSetSoundPan(sound: [*c]Sound, pan: f32) void;
pub extern fn mWaveCopy(out: [*c]Wave, wave: [*c]Wave) void;
pub extern fn mWaveCrop(wave: [*c]Wave, initSample: c_int, finalSample: c_int) void;
pub extern fn mWaveFormat(wave: [*c]Wave, sampleRate: c_int, sampleSize: c_int, channels: c_int) void;
pub extern fn mLoadWaveSamples(wave: [*c]Wave) [*c]f32;
pub extern fn mUnloadWaveSamples(samples: [*c]f32) void;
pub extern fn mLoadMusicStream(out: [*c]Music, fileName: [*c]const u8) void;
pub extern fn mLoadMusicStreamFromMemory(out: [*c]Music, fileType: [*c]const u8, data: [*c]const u8, dataSize: c_int) void;
pub extern fn mIsMusicReady(music: [*c]Music) bool;
pub extern fn mUnloadMusicStream(music: [*c]Music) void;
pub extern fn mPlayMusicStream(music: [*c]Music) void;
pub extern fn mIsMusicStreamPlaying(music: [*c]Music) bool;
pub extern fn mUpdateMusicStream(music: [*c]Music) void;
pub extern fn mStopMusicStream(music: [*c]Music) void;
pub extern fn mPauseMusicStream(music: [*c]Music) void;
pub extern fn mResumeMusicStream(music: [*c]Music) void;
pub extern fn mSeekMusicStream(music: [*c]Music, position: f32) void;
pub extern fn mSetMusicVolume(music: [*c]Music, volume: f32) void;
pub extern fn mSetMusicPitch(music: [*c]Music, pitch: f32) void;
pub extern fn mSetMusicPan(music: [*c]Music, pan: f32) void;
pub extern fn mGetMusicTimeLength(music: [*c]Music) f32;
pub extern fn mGetMusicTimePlayed(music: [*c]Music) f32;
pub extern fn mLoadAudioStream(out: [*c]AudioStream, sampleRate: c_uint, sampleSize: c_uint, channels: c_uint) void;
pub extern fn mIsAudioStreamReady(stream: [*c]AudioStream) bool;
pub extern fn mUnloadAudioStream(stream: [*c]AudioStream) void;
pub extern fn mUpdateAudioStream(stream: [*c]AudioStream, data: ?*const anyopaque, frameCount: c_int) void;
pub extern fn mIsAudioStreamProcessed(stream: [*c]AudioStream) bool;
pub extern fn mPlayAudioStream(stream: [*c]AudioStream) void;
pub extern fn mPauseAudioStream(stream: [*c]AudioStream) void;
pub extern fn mResumeAudioStream(stream: [*c]AudioStream) void;
pub extern fn mIsAudioStreamPlaying(stream: [*c]AudioStream) bool;
pub extern fn mStopAudioStream(stream: [*c]AudioStream) void;
pub extern fn mSetAudioStreamVolume(stream: [*c]AudioStream, volume: f32) void;
pub extern fn mSetAudioStreamPitch(stream: [*c]AudioStream, pitch: f32) void;
pub extern fn mSetAudioStreamPan(stream: [*c]AudioStream, pan: f32) void;
pub extern fn mSetAudioStreamBufferSizeDefault(size: c_int) void;
pub extern fn mSetAudioStreamCallback(stream: [*c]AudioStream, callback: AudioCallback) void;
pub extern fn mAttachAudioStreamProcessor(stream: [*c]AudioStream, processor: AudioCallback) void;
pub extern fn mDetachAudioStreamProcessor(stream: [*c]AudioStream, processor: AudioCallback) void;
pub extern fn mAttachAudioMixedProcessor(processor: AudioCallback) void;
pub extern fn mDetachAudioMixedProcessor(processor: AudioCallback) void;
pub extern fn mrlMatrixMode(mode: c_int) void;
pub extern fn mrlPushMatrix() void;
pub extern fn mrlPopMatrix() void;
pub extern fn mrlLoadIdentity() void;
pub extern fn mrlTranslatef(x: f32, y: f32, z: f32) void;
pub extern fn mrlRotatef(angle: f32, x: f32, y: f32, z: f32) void;
pub extern fn mrlScalef(x: f32, y: f32, z: f32) void;
pub extern fn mrlMultMatrixf(matf: [*c]const f32) void;
pub extern fn mrlFrustum(left: f64, right: f64, bottom: f64, top: f64, znear: f64, zfar: f64) void;
pub extern fn mrlOrtho(left: f64, right: f64, bottom: f64, top: f64, znear: f64, zfar: f64) void;
pub extern fn mrlViewport(x: c_int, y: c_int, width: c_int, height: c_int) void;
pub extern fn mrlBegin(mode: c_int) void;
pub extern fn mrlEnd() void;
pub extern fn mrlVertex2i(x: c_int, y: c_int) void;
pub extern fn mrlVertex2f(x: f32, y: f32) void;
pub extern fn mrlVertex3f(x: f32, y: f32, z: f32) void;
pub extern fn mrlTexCoord2f(x: f32, y: f32) void;
pub extern fn mrlNormal3f(x: f32, y: f32, z: f32) void;
pub extern fn mrlColor4ub(r: u8, g: u8, b: u8, a: u8) void;
pub extern fn mrlColor3f(x: f32, y: f32, z: f32) void;
pub extern fn mrlColor4f(x: f32, y: f32, z: f32, w: f32) void;
pub extern fn mrlEnableVertexArray(vaoId: c_uint) bool;
pub extern fn mrlDisableVertexArray() void;
pub extern fn mrlEnableVertexBuffer(id: c_uint) void;
pub extern fn mrlDisableVertexBuffer() void;
pub extern fn mrlEnableVertexBufferElement(id: c_uint) void;
pub extern fn mrlDisableVertexBufferElement() void;
pub extern fn mrlEnableVertexAttribute(index: c_uint) void;
pub extern fn mrlDisableVertexAttribute(index: c_uint) void;
pub extern fn mrlActiveTextureSlot(slot: c_int) void;
pub extern fn mrlEnableTexture(id: c_uint) void;
pub extern fn mrlDisableTexture() void;
pub extern fn mrlEnableTextureCubemap(id: c_uint) void;
pub extern fn mrlDisableTextureCubemap() void;
pub extern fn mrlTextureParameters(id: c_uint, param: c_int, value: c_int) void;
pub extern fn mrlCubemapParameters(id: c_uint, param: c_int, value: c_int) void;
pub extern fn mrlEnableShader(id: c_uint) void;
pub extern fn mrlDisableShader() void;
pub extern fn mrlEnableFramebuffer(id: c_uint) void;
pub extern fn mrlDisableFramebuffer() void;
pub extern fn mrlActiveDrawBuffers(count: c_int) void;
pub extern fn mrlBlitFramebuffer(srcX: c_int, srcY: c_int, srcWidth: c_int, srcHeight: c_int, dstX: c_int, dstY: c_int, dstWidth: c_int, dstHeight: c_int, bufferMask: c_int) void;
pub extern fn mrlBindFramebuffer(target: c_uint, framebuffer: c_uint) void;
pub extern fn mrlEnableColorBlend() void;
pub extern fn mrlDisableColorBlend() void;
pub extern fn mrlEnableDepthTest() void;
pub extern fn mrlDisableDepthTest() void;
pub extern fn mrlEnableDepthMask() void;
pub extern fn mrlDisableDepthMask() void;
pub extern fn mrlEnableBackfaceCulling() void;
pub extern fn mrlDisableBackfaceCulling() void;
pub extern fn mrlColorMask(r: bool, g: bool, b: bool, a: bool) void;
pub extern fn mrlSetCullFace(mode: c_int) void;
pub extern fn mrlEnableScissorTest() void;
pub extern fn mrlDisableScissorTest() void;
pub extern fn mrlScissor(x: c_int, y: c_int, width: c_int, height: c_int) void;
pub extern fn mrlEnableWireMode() void;
pub extern fn mrlEnablePointMode() void;
pub extern fn mrlDisableWireMode() void;
pub extern fn mrlSetLineWidth(width: f32) void;
pub extern fn mrlGetLineWidth() f32;
pub extern fn mrlEnableSmoothLines() void;
pub extern fn mrlDisableSmoothLines() void;
pub extern fn mrlEnableStereoRender() void;
pub extern fn mrlDisableStereoRender() void;
pub extern fn mrlIsStereoRenderEnabled() bool;
pub extern fn mrlClearColor(r: u8, g: u8, b: u8, a: u8) void;
pub extern fn mrlClearScreenBuffers() void;
pub extern fn mrlCheckErrors() void;
pub extern fn mrlSetBlendMode(mode: c_int) void;
pub extern fn mrlSetBlendFactors(glSrcFactor: c_int, glDstFactor: c_int, glEquation: c_int) void;
pub extern fn mrlSetBlendFactorsSeparate(glSrcRGB: c_int, glDstRGB: c_int, glSrcAlpha: c_int, glDstAlpha: c_int, glEqRGB: c_int, glEqAlpha: c_int) void;
pub extern fn mrlglInit(width: c_int, height: c_int) void;
pub extern fn mrlglClose() void;
pub extern fn mrlLoadExtensions(loader: ?*anyopaque) void;
pub extern fn mrlGetVersion() c_int;
pub extern fn mrlSetFramebufferWidth(width: c_int) void;
pub extern fn mrlGetFramebufferWidth() c_int;
pub extern fn mrlSetFramebufferHeight(height: c_int) void;
pub extern fn mrlGetFramebufferHeight() c_int;
pub extern fn mrlGetTextureIdDefault() c_uint;
pub extern fn mrlGetShaderIdDefault() c_uint;
pub extern fn mrlGetShaderLocsDefault() [*c]c_int;
pub extern fn mrlLoadRenderBatch(out: [*c]rlRenderBatch, numBuffers: c_int, bufferElements: c_int) void;
pub extern fn mrlUnloadRenderBatch(batch: [*c]rlRenderBatch) void;
pub extern fn mrlDrawRenderBatch(batch: [*c]rlRenderBatch) void;
pub extern fn mrlSetRenderBatchActive(batch: [*c]rlRenderBatch) void;
pub extern fn mrlDrawRenderBatchActive() void;
pub extern fn mrlCheckRenderBatchLimit(vCount: c_int) bool;
pub extern fn mrlSetTexture(id: c_uint) void;
pub extern fn mrlLoadVertexArray() c_uint;
pub extern fn mrlLoadVertexBuffer(buffer: ?*const anyopaque, size: c_int, dynamic: bool) c_uint;
pub extern fn mrlLoadVertexBufferElement(buffer: ?*const anyopaque, size: c_int, dynamic: bool) c_uint;
pub extern fn mrlUpdateVertexBuffer(bufferId: c_uint, data: ?*const anyopaque, dataSize: c_int, offset: c_int) void;
pub extern fn mrlUpdateVertexBufferElements(id: c_uint, data: ?*const anyopaque, dataSize: c_int, offset: c_int) void;
pub extern fn mrlUnloadVertexArray(vaoId: c_uint) void;
pub extern fn mrlUnloadVertexBuffer(vboId: c_uint) void;
pub extern fn mrlSetVertexAttribute(index: c_uint, compSize: c_int, @"type": c_int, normalized: bool, stride: c_int, pointer: ?*const anyopaque) void;
pub extern fn mrlSetVertexAttributeDivisor(index: c_uint, divisor: c_int) void;
pub extern fn mrlSetVertexAttributeDefault(locIndex: c_int, value: ?*const anyopaque, attribType: c_int, count: c_int) void;
pub extern fn mrlDrawVertexArray(offset: c_int, count: c_int) void;
pub extern fn mrlDrawVertexArrayElements(offset: c_int, count: c_int, buffer: ?*const anyopaque) void;
pub extern fn mrlDrawVertexArrayInstanced(offset: c_int, count: c_int, instances: c_int) void;
pub extern fn mrlDrawVertexArrayElementsInstanced(offset: c_int, count: c_int, buffer: ?*const anyopaque, instances: c_int) void;
pub extern fn mrlLoadTexture(data: ?*const anyopaque, width: c_int, height: c_int, format: c_int, mipmapCount: c_int) c_uint;
pub extern fn mrlLoadTextureDepth(width: c_int, height: c_int, useRenderBuffer: bool) c_uint;
pub extern fn mrlLoadTextureCubemap(data: ?*const anyopaque, size: c_int, format: c_int) c_uint;
pub extern fn mrlUpdateTexture(id: c_uint, offsetX: c_int, offsetY: c_int, width: c_int, height: c_int, format: c_int, data: ?*const anyopaque) void;
pub extern fn mrlGetGlTextureFormats(format: c_int, glInternalFormat: [*c]c_uint, glFormat: [*c]c_uint, glType: [*c]c_uint) void;
pub extern fn mrlGetPixelFormatName(format: c_uint) [*c]const u8;
pub extern fn mrlUnloadTexture(id: c_uint) void;
pub extern fn mrlGenTextureMipmaps(id: c_uint, width: c_int, height: c_int, format: c_int, mipmaps: [*c]c_int) void;
pub extern fn mrlReadTexturePixels(id: c_uint, width: c_int, height: c_int, format: c_int) ?*anyopaque;
pub extern fn mrlReadScreenPixels(width: c_int, height: c_int) [*c]u8;
pub extern fn mrlLoadFramebuffer(width: c_int, height: c_int) c_uint;
pub extern fn mrlFramebufferAttach(fboId: c_uint, texId: c_uint, attachType: c_int, texType: c_int, mipLevel: c_int) void;
pub extern fn mrlFramebufferComplete(id: c_uint) bool;
pub extern fn mrlUnloadFramebuffer(id: c_uint) void;
pub extern fn mrlLoadShaderCode(vsCode: [*c]const u8, fsCode: [*c]const u8) c_uint;
pub extern fn mrlCompileShader(shaderCode: [*c]const u8, @"type": c_int) c_uint;
pub extern fn mrlLoadShaderProgram(vShaderId: c_uint, fShaderId: c_uint) c_uint;
pub extern fn mrlUnloadShaderProgram(id: c_uint) void;
pub extern fn mrlGetLocationUniform(shaderId: c_uint, uniformName: [*c]const u8) c_int;
pub extern fn mrlGetLocationAttrib(shaderId: c_uint, attribName: [*c]const u8) c_int;
pub extern fn mrlSetUniform(locIndex: c_int, value: ?*const anyopaque, uniformType: c_int, count: c_int) void;
pub extern fn mrlSetUniformMatrix(locIndex: c_int, mat: [*c]Matrix) void;
pub extern fn mrlSetUniformSampler(locIndex: c_int, textureId: c_uint) void;
pub extern fn mrlSetShader(id: c_uint, locs: [*c]c_int) void;
pub extern fn mrlLoadComputeShaderProgram(shaderId: c_uint) c_uint;
pub extern fn mrlComputeShaderDispatch(groupX: c_uint, groupY: c_uint, groupZ: c_uint) void;
pub extern fn mrlLoadShaderBuffer(size: c_uint, data: ?*const anyopaque, usageHint: c_int) c_uint;
pub extern fn mrlUnloadShaderBuffer(ssboId: c_uint) void;
pub extern fn mrlUpdateShaderBuffer(id: c_uint, data: ?*const anyopaque, dataSize: c_uint, offset: c_uint) void;
pub extern fn mrlBindShaderBuffer(id: c_uint, index: c_uint) void;
pub extern fn mrlReadShaderBuffer(id: c_uint, dest: ?*anyopaque, count: c_uint, offset: c_uint) void;
pub extern fn mrlCopyShaderBuffer(destId: c_uint, srcId: c_uint, destOffset: c_uint, srcOffset: c_uint, count: c_uint) void;
pub extern fn mrlGetShaderBufferSize(id: c_uint) c_uint;
pub extern fn mrlBindImageTexture(id: c_uint, index: c_uint, format: c_int, readonly: bool) void;
pub extern fn mrlGetMatrixModelview(out: [*c]Matrix) void;
pub extern fn mrlGetMatrixProjection(out: [*c]Matrix) void;
pub extern fn mrlGetMatrixTransform(out: [*c]Matrix) void;
pub extern fn mrlGetMatrixProjectionStereo(out: [*c]Matrix, eye: c_int) void;
pub extern fn mrlGetMatrixViewOffsetStereo(out: [*c]Matrix, eye: c_int) void;
pub extern fn mrlSetMatrixProjection(proj: [*c]Matrix) void;
pub extern fn mrlSetMatrixModelview(view: [*c]Matrix) void;
pub extern fn mrlSetMatrixProjectionStereo(right: [*c]Matrix, left: [*c]Matrix) void;
pub extern fn mrlSetMatrixViewOffsetStereo(right: [*c]Matrix, left: [*c]Matrix) void;
pub extern fn mrlLoadDrawCube() void;
pub extern fn mrlLoadDrawQuad() void;
pub extern fn mClamp(value: f32, min: f32, max: f32) f32;
pub extern fn mLerp(start: f32, end: f32, amount: f32) f32;
pub extern fn mNormalize(value: f32, start: f32, end: f32) f32;
pub extern fn mRemap(value: f32, inputStart: f32, inputEnd: f32, outputStart: f32, outputEnd: f32) f32;
pub extern fn mWrap(value: f32, min: f32, max: f32) f32;
pub extern fn mFloatEquals(x: f32, y: f32) c_int;
pub extern fn mVector2Zero(out: [*c]Vector2) void;
pub extern fn mVector2One(out: [*c]Vector2) void;
pub extern fn mVector2Add(out: [*c]Vector2, v1: [*c]Vector2, v2: [*c]Vector2) void;
pub extern fn mVector2AddValue(out: [*c]Vector2, v: [*c]Vector2, add: f32) void;
pub extern fn mVector2Subtract(out: [*c]Vector2, v1: [*c]Vector2, v2: [*c]Vector2) void;
pub extern fn mVector2SubtractValue(out: [*c]Vector2, v: [*c]Vector2, sub: f32) void;
pub extern fn mVector2Length(v: [*c]Vector2) f32;
pub extern fn mVector2LengthSqr(v: [*c]Vector2) f32;
pub extern fn mVector2DotProduct(v1: [*c]Vector2, v2: [*c]Vector2) f32;
pub extern fn mVector2Distance(v1: [*c]Vector2, v2: [*c]Vector2) f32;
pub extern fn mVector2DistanceSqr(v1: [*c]Vector2, v2: [*c]Vector2) f32;
pub extern fn mVector2Angle(v1: [*c]Vector2, v2: [*c]Vector2) f32;
pub extern fn mVector2LineAngle(start: [*c]Vector2, end: [*c]Vector2) f32;
pub extern fn mVector2Scale(out: [*c]Vector2, v: [*c]Vector2, scale: f32) void;
pub extern fn mVector2Multiply(out: [*c]Vector2, v1: [*c]Vector2, v2: [*c]Vector2) void;
pub extern fn mVector2Negate(out: [*c]Vector2, v: [*c]Vector2) void;
pub extern fn mVector2Divide(out: [*c]Vector2, v1: [*c]Vector2, v2: [*c]Vector2) void;
pub extern fn mVector2Normalize(out: [*c]Vector2, v: [*c]Vector2) void;
pub extern fn mVector2Transform(out: [*c]Vector2, v: [*c]Vector2, mat: [*c]Matrix) void;
pub extern fn mVector2Lerp(out: [*c]Vector2, v1: [*c]Vector2, v2: [*c]Vector2, amount: f32) void;
pub extern fn mVector2Reflect(out: [*c]Vector2, v: [*c]Vector2, normal: [*c]Vector2) void;
pub extern fn mVector2Rotate(out: [*c]Vector2, v: [*c]Vector2, angle: f32) void;
pub extern fn mVector2MoveTowards(out: [*c]Vector2, v: [*c]Vector2, target: [*c]Vector2, maxDistance: f32) void;
pub extern fn mVector2Invert(out: [*c]Vector2, v: [*c]Vector2) void;
pub extern fn mVector2Clamp(out: [*c]Vector2, v: [*c]Vector2, min: [*c]Vector2, max: [*c]Vector2) void;
pub extern fn mVector2ClampValue(out: [*c]Vector2, v: [*c]Vector2, min: f32, max: f32) void;
pub extern fn mVector2Equals(p: [*c]Vector2, q: [*c]Vector2) c_int;
pub extern fn mVector3Zero(out: [*c]Vector3) void;
pub extern fn mVector3One(out: [*c]Vector3) void;
pub extern fn mVector3Add(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3AddValue(out: [*c]Vector3, v: [*c]Vector3, add: f32) void;
pub extern fn mVector3Subtract(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3SubtractValue(out: [*c]Vector3, v: [*c]Vector3, sub: f32) void;
pub extern fn mVector3Scale(out: [*c]Vector3, v: [*c]Vector3, scalar: f32) void;
pub extern fn mVector3Multiply(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3CrossProduct(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3Perpendicular(out: [*c]Vector3, v: [*c]Vector3) void;
pub extern fn mVector3Length(v: [*c]const Vector3) f32;
pub extern fn mVector3LengthSqr(v: [*c]const Vector3) f32;
pub extern fn mVector3DotProduct(v1: [*c]Vector3, v2: [*c]Vector3) f32;
pub extern fn mVector3Distance(v1: [*c]Vector3, v2: [*c]Vector3) f32;
pub extern fn mVector3DistanceSqr(v1: [*c]Vector3, v2: [*c]Vector3) f32;
pub extern fn mVector3Angle(v1: [*c]Vector3, v2: [*c]Vector3) f32;
pub extern fn mVector3Negate(out: [*c]Vector3, v: [*c]Vector3) void;
pub extern fn mVector3Divide(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3Normalize(out: [*c]Vector3, v: [*c]Vector3) void;
pub extern fn mVector3Project(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3Reject(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3OrthoNormalize(v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3Transform(out: [*c]Vector3, v: [*c]Vector3, mat: [*c]Matrix) void;
pub extern fn mVector3RotateByQuaternion(out: [*c]Vector3, v: [*c]Vector3, q: [*c]Vector4) void;
pub extern fn mVector3RotateByAxisAngle(out: [*c]Vector3, v: [*c]Vector3, axis: [*c]Vector3, angle: f32) void;
pub extern fn mVector3Lerp(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3, amount: f32) void;
pub extern fn mVector3Reflect(out: [*c]Vector3, v: [*c]Vector3, normal: [*c]Vector3) void;
pub extern fn mVector3Min(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3Max(out: [*c]Vector3, v1: [*c]Vector3, v2: [*c]Vector3) void;
pub extern fn mVector3Barycenter(out: [*c]Vector3, p: [*c]Vector3, a: [*c]Vector3, b: [*c]Vector3, c: [*c]Vector3) void;
pub extern fn mVector3Unproject(out: [*c]Vector3, source: [*c]Vector3, projection: [*c]Matrix, view: [*c]Matrix) void;
pub extern fn mVector3ToFloatV(out: [*c]float3, v: [*c]Vector3) void;
pub extern fn mVector3Invert(out: [*c]Vector3, v: [*c]Vector3) void;
pub extern fn mVector3Clamp(out: [*c]Vector3, v: [*c]Vector3, min: [*c]Vector3, max: [*c]Vector3) void;
pub extern fn mVector3ClampValue(out: [*c]Vector3, v: [*c]Vector3, min: f32, max: f32) void;
pub extern fn mVector3Equals(p: [*c]Vector3, q: [*c]Vector3) c_int;
pub extern fn mVector3Refract(out: [*c]Vector3, v: [*c]Vector3, n: [*c]Vector3, r: f32) void;
pub extern fn mMatrixDeterminant(mat: [*c]Matrix) f32;
pub extern fn mMatrixTrace(mat: [*c]Matrix) f32;
pub extern fn mMatrixTranspose(out: [*c]Matrix, mat: [*c]Matrix) void;
pub extern fn mMatrixInvert(out: [*c]Matrix, mat: [*c]Matrix) void;
pub extern fn mMatrixIdentity(out: [*c]Matrix) void;
pub extern fn mMatrixAdd(out: [*c]Matrix, left: [*c]Matrix, right: [*c]Matrix) void;
pub extern fn mMatrixSubtract(out: [*c]Matrix, left: [*c]Matrix, right: [*c]Matrix) void;
pub extern fn mMatrixMultiply(out: [*c]Matrix, left: [*c]Matrix, right: [*c]Matrix) void;
pub extern fn mMatrixTranslate(out: [*c]Matrix, x: f32, y: f32, z: f32) void;
pub extern fn mMatrixRotate(out: [*c]Matrix, axis: [*c]Vector3, angle: f32) void;
pub extern fn mMatrixRotateX(out: [*c]Matrix, angle: f32) void;
pub extern fn mMatrixRotateY(out: [*c]Matrix, angle: f32) void;
pub extern fn mMatrixRotateZ(out: [*c]Matrix, angle: f32) void;
pub extern fn mMatrixRotateXYZ(out: [*c]Matrix, angle: [*c]Vector3) void;
pub extern fn mMatrixRotateZYX(out: [*c]Matrix, angle: [*c]Vector3) void;
pub extern fn mMatrixScale(out: [*c]Matrix, x: f32, y: f32, z: f32) void;
pub extern fn mMatrixFrustum(out: [*c]Matrix, left: f64, right: f64, bottom: f64, top: f64, near: f64, far: f64) void;
pub extern fn mMatrixPerspective(out: [*c]Matrix, fovY: f64, aspect: f64, nearPlane: f64, farPlane: f64) void;
pub extern fn mMatrixOrtho(out: [*c]Matrix, left: f64, right: f64, bottom: f64, top: f64, nearPlane: f64, farPlane: f64) void;
pub extern fn mMatrixLookAt(out: [*c]Matrix, eye: [*c]Vector3, target: [*c]Vector3, up: [*c]Vector3) void;
pub extern fn mMatrixToFloatV(out: [*c]float16, mat: [*c]Matrix) void;
pub extern fn mQuaternionAdd(out: [*c]Vector4, q1: [*c]Vector4, q2: [*c]Vector4) void;
pub extern fn mQuaternionAddValue(out: [*c]Vector4, q: [*c]Vector4, add: f32) void;
pub extern fn mQuaternionSubtract(out: [*c]Vector4, q1: [*c]Vector4, q2: [*c]Vector4) void;
pub extern fn mQuaternionSubtractValue(out: [*c]Vector4, q: [*c]Vector4, sub: f32) void;
pub extern fn mQuaternionIdentity(out: [*c]Vector4) void;
pub extern fn mQuaternionLength(q: [*c]Vector4) f32;
pub extern fn mQuaternionNormalize(out: [*c]Vector4, q: [*c]Vector4) void;
pub extern fn mQuaternionInvert(out: [*c]Vector4, q: [*c]Vector4) void;
pub extern fn mQuaternionMultiply(out: [*c]Vector4, q1: [*c]Vector4, q2: [*c]Vector4) void;
pub extern fn mQuaternionScale(out: [*c]Vector4, q: [*c]Vector4, mul: f32) void;
pub extern fn mQuaternionDivide(out: [*c]Vector4, q1: [*c]Vector4, q2: [*c]Vector4) void;
pub extern fn mQuaternionLerp(out: [*c]Vector4, q1: [*c]Vector4, q2: [*c]Vector4, amount: f32) void;
pub extern fn mQuaternionNlerp(out: [*c]Vector4, q1: [*c]Vector4, q2: [*c]Vector4, amount: f32) void;
pub extern fn mQuaternionSlerp(out: [*c]Vector4, q1: [*c]Vector4, q2: [*c]Vector4, amount: f32) void;
pub extern fn mQuaternionFromVector3ToVector3(out: [*c]Vector4, from: [*c]Vector3, to: [*c]Vector3) void;
pub extern fn mQuaternionFromMatrix(out: [*c]Vector4, mat: [*c]Matrix) void;
pub extern fn mQuaternionToMatrix(out: [*c]Matrix, q: [*c]Vector4) void;
pub extern fn mQuaternionFromAxisAngle(out: [*c]Vector4, axis: [*c]Vector3, angle: f32) void;
pub extern fn mQuaternionToAxisAngle(q: [*c]Vector4, outAxis: [*c]Vector3, outAngle: [*c]f32) void;
pub extern fn mQuaternionFromEuler(out: [*c]Vector4, pitch: f32, yaw: f32, roll: f32) void;
pub extern fn mQuaternionToEuler(out: [*c]Vector3, q: [*c]Vector4) void;
pub extern fn mQuaternionTransform(out: [*c]Vector4, q: [*c]Vector4, mat: [*c]Matrix) void;
pub extern fn mQuaternionEquals(p: [*c]Vector4, q: [*c]Vector4) c_int;
...
pub const __declspec = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):413:9
pub const _cdecl = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):414:9
pub const __cdecl = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):415:9
pub const _stdcall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):416:9
pub const __stdcall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):417:9
pub const _fastcall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):418:9
pub const __fastcall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):419:9
pub const _thiscall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):420:9
pub const __thiscall = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):421:9
pub const _pascal = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):422:9
pub const __pascal = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // (no file):423:9
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\include/stdarg.h:46:9
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // C:\Users\user\Documents\GitHub\bouncelang\raylib.zig\raylib\src/raylib.h:127:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // C:\Users\user\Documents\GitHub\bouncelang\raylib.zig\raylib\src/raylib.h:130:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // C:\Users\user\Documents\GitHub\bouncelang\raylib.zig\raylib\src/raylib.h:133:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // C:\Users\user\Documents\GitHub\bouncelang\raylib.zig\raylib\src/raylib.h:136:13
pub const TRACELOG = @compileError("unable to translate C expr: expected ')' instead got '...'"); // C:\Users\user\Documents\GitHub\bouncelang\raylib.zig\raylib\src/rlgl.h:131:13
pub const TRACELOGD = @compileError("unable to translate C expr: expected ')' instead got '...'"); // C:\Users\user\Documents\GitHub\bouncelang\raylib.zig\raylib\src/rlgl.h:132:13
pub const RMAPI = @compileError("unable to translate C expr: unexpected token 'extern'"); // C:\Users\user\Documents\GitHub\bouncelang\raylib.zig\raylib\src/raymath.h:68:17
pub const __STRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:10:9
pub const __MINGW64_VERSION_STR = @compileError("unable to translate C expr: unexpected token 'StringLiteral'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:26:9
pub const __MINGW_IMP_SYMBOL = @compileError("unable to translate macro: undefined identifier `__imp_`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:119:11
pub const __MINGW_IMP_LSYMBOL = @compileError("unable to translate macro: undefined identifier `__imp_`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:120:11
pub const __MINGW_LSYMBOL = @compileError("unable to translate C expr: unexpected token '##'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:122:11
pub const __MINGW_ASM_CALL = @compileError("unable to translate macro: undefined identifier `__asm__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:130:9
pub const __MINGW_ASM_CRT_CALL = @compileError("unable to translate macro: undefined identifier `__asm__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:131:9
pub const __MINGW_EXTENSION = @compileError("unable to translate macro: undefined identifier `__extension__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:163:13
pub const __MINGW_POISON_NAME = @compileError("unable to translate macro: undefined identifier `_layout_has_not_been_verified_and_its_declaration_is_most_likely_incorrect`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:203:11
pub const __MINGW_ATTRIB_DEPRECATED_STR = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:247:11
pub const __MINGW_MS_PRINTF = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:270:9
pub const __MINGW_MS_SCANF = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:273:9
pub const __MINGW_GNU_PRINTF = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:276:9
pub const __MINGW_GNU_SCANF = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:279:9
pub const __mingw_ovr = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:289:11
pub const __MINGW_SELECTANY = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_mac.h:304:9
pub const __MINGW_CRT_NAME_CONCAT2 = @compileError("unable to translate macro: undefined identifier `_s`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_secapi.h:41:9
pub const __CRT_SECURE_CPP_OVERLOAD_STANDARD_NAMES_MEMORY_0_3_ = @compileError("unable to translate C expr: unexpected token 'Identifier'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw_secapi.h:69:9
pub const __MINGW_IMPORT = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:51:12
pub const _CRTIMP = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:59:15
pub const _inline = @compileError("unable to translate macro: undefined identifier `__inline`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:81:9
pub const __CRT_INLINE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:90:11
pub const __MINGW_INTRIN_INLINE = @compileError("unable to translate macro: undefined identifier `__inline__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:97:9
pub const __UNUSED_PARAM = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:111:11
pub const __restrict_arr = @compileError("unable to translate macro: undefined identifier `__restrict`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:126:10
pub const __MINGW_ATTRIB_NORETURN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:142:9
pub const __MINGW_ATTRIB_CONST = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:143:9
pub const __MINGW_ATTRIB_MALLOC = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:153:9
pub const __MINGW_ATTRIB_PURE = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:154:9
pub const __MINGW_ATTRIB_NONNULL = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:167:9
pub const __MINGW_ATTRIB_UNUSED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:173:9
pub const __MINGW_ATTRIB_USED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:179:9
pub const __MINGW_ATTRIB_DEPRECATED = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:180:9
pub const __MINGW_ATTRIB_DEPRECATED_MSG = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:182:9
pub const __MINGW_NOTHROW = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:197:9
pub const __MINGW_PRAGMA_PARAM = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:215:9
pub const __MINGW_BROKEN_INTERFACE = @compileError("unable to translate macro: undefined identifier `message`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:218:9
pub const __forceinline = @compileError("unable to translate macro: undefined identifier `__inline__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:273:9
pub const _crt_va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/vadefs.h:48:9
pub const _crt_va_arg = @compileError("unable to translate macro: undefined identifier `__builtin_va_arg`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/vadefs.h:49:9
pub const _crt_va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/vadefs.h:50:9
pub const _crt_va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/vadefs.h:51:9
pub const __CRT_STRINGIZE = @compileError("unable to translate C expr: unexpected token '#'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:292:9
pub const __CRT_WIDE = @compileError("unable to translate macro: undefined identifier `L`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:297:9
pub const _CRT_DEPRECATE_TEXT = @compileError("unable to translate macro: undefined identifier `deprecated`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:356:9
pub const _CRT_INSECURE_DEPRECATE_MEMORY = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:359:9
pub const _CRT_INSECURE_DEPRECATE_GLOBALS = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:363:9
pub const _CRT_OBSOLETE = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:371:9
pub const _CRT_ALIGN = @compileError("unable to translate macro: undefined identifier `__attribute__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:398:9
pub const _CRT_glob = @compileError("unable to translate macro: undefined identifier `_dowildcard`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:462:9
pub const _UNION_NAME = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:482:9
pub const _STRUCT_NAME = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:483:9
pub const __CRT_UUID_DECL = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/_mingw.h:570:9
pub const _CRT_SECURE_CPP_NOTHROW = @compileError("unable to translate macro: undefined identifier `throw`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:143:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_0 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:262:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:263:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:264:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_3 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:265:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_4 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:266:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_1_1 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:267:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_1_2 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:268:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_1_3 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:269:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_2_0 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:270:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_1_ARGLIST = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:271:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_0_2_ARGLIST = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:272:9
pub const __DEFINE_CPP_OVERLOAD_SECURE_FUNC_SPLITPATH = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:273:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0 = @compileError("unable to translate macro: undefined identifier `__func_name`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:277:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1 = @compileError("unable to translate macro: undefined identifier `__func_name`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:279:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2 = @compileError("unable to translate macro: undefined identifier `__func_name`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:281:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3 = @compileError("unable to translate macro: undefined identifier `__func_name`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:283:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_4 = @compileError("unable to translate macro: undefined identifier `__func_name`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:285:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0_EX = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:422:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_EX = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:423:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_EX = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:424:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_3_EX = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:425:9
pub const __DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_4_EX = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:426:9
pub const __crt_typefix = @compileError("unable to translate C expr: unexpected token 'Eof'"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/corecrt.h:486:9
pub const __mingw_types_compatible_p = @compileError("unable to translate macro: undefined identifier `__builtin_types_compatible_p`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:97:9
pub const __mingw_choose_expr = @compileError("unable to translate macro: undefined identifier `__builtin_choose_expr`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:105:9
pub const HUGE_VAL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_val`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:156:9
pub const HUGE_VALL = @compileError("unable to translate macro: undefined identifier `__builtin_huge_vall`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:350:9
pub const fpclassify = @compileError("unable to translate macro: undefined identifier `__typeof__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:492:9
pub const isnan = @compileError("unable to translate macro: undefined identifier `__typeof__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:586:9
pub const signbit = @compileError("unable to translate macro: undefined identifier `__typeof__`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:646:9
pub const isgreater = @compileError("unable to translate macro: undefined identifier `__builtin_isgreater`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:1144:9
pub const isgreaterequal = @compileError("unable to translate macro: undefined identifier `__builtin_isgreaterequal`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:1145:9
pub const isless = @compileError("unable to translate macro: undefined identifier `__builtin_isless`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:1146:9
pub const islessequal = @compileError("unable to translate macro: undefined identifier `__builtin_islessequal`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:1147:9
pub const islessgreater = @compileError("unable to translate macro: undefined identifier `__builtin_islessgreater`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:1148:9
pub const isunordered = @compileError("unable to translate macro: undefined identifier `__builtin_isunordered`"); // C:\Users\user\Downloads\zig-windows-x86_64-0.11.0\lib\libc\include\any-windows-any/math.h:1149:9
...
pub const GRAPHICS_API_OPENGL_11 = "";
pub const RLGL_H = "";
...
pub const RL_CONSTANT_COLOR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8001, .hexadecimal);
pub const RL_ONE_MINUS_CONSTANT_COLOR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8002, .hexadecimal);
pub const RL_CONSTANT_ALPHA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8003, .hexadecimal);
pub const RL_ONE_MINUS_CONSTANT_ALPHA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8004, .hexadecimal);
pub const RL_FUNC_ADD = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8006, .hexadecimal);
pub const RL_MIN = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8007, .hexadecimal);
pub const RL_MAX = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8008, .hexadecimal);
pub const RL_FUNC_SUBTRACT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x800A, .hexadecimal);
pub const RL_FUNC_REVERSE_SUBTRACT = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x800B, .hexadecimal);
pub const RL_BLEND_EQUATION = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8009, .hexadecimal);
pub const RL_BLEND_EQUATION_RGB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8009, .hexadecimal);
pub const RL_BLEND_EQUATION_ALPHA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x883D, .hexadecimal);
pub const RL_BLEND_DST_RGB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80C8, .hexadecimal);
pub const RL_BLEND_SRC_RGB = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80C9, .hexadecimal);
pub const RL_BLEND_DST_ALPHA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80CA, .hexadecimal);
pub const RL_BLEND_SRC_ALPHA = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x80CB, .hexadecimal);
pub const RL_BLEND_COLOR = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8005, .hexadecimal);
pub const RL_READ_FRAMEBUFFER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8CA8, .hexadecimal);
pub const RL_DRAW_FRAMEBUFFER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x8CA9, .hexadecimal);
...
pub const RAYMATH_IMPLEMENTATION = "";
pub const RAYMATH_H = "";
